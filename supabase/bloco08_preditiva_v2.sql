...
-- ============================================================
-- 1. CRIAR TABELAS SEM FKs PRIMEIRO
-- ============================================================
...
-- ============================================================
-- 3. FOREIGN KEYS APENAS SE TABELAS EXISTIREM
-- ============================================================
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'equipments' AND table_schema = 'public') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'predictive_measurements' AND table_schema = 'public') THEN
    ALTER TABLE public.predictive_alerts ADD CONSTRAINT fk_predictive_alerts_measurement FOREIGN KEY (measurement_id) REFERENCES public.predictive_measurements(id);
  END IF;
END $$;

DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'predictive_alert_rules' AND table_schema = 'public') THEN
    ALTER TABLE public.predictive_alerts ADD CONSTRAINT fk_predictive_alerts_rule FOREIGN KEY (rule_id) REFERENCES public.predictive_alert_rules(id);
  END IF;
END $$;
